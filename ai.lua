--[[
    ...
    Represents a ai that can move up and down. Used in the main
...
--[[
    ...
    Our ai should take an X and a Y, for positioning, as well as a width
...
function ai:update(dt)
    ...
    -- previously-defined ai speed scaled by dt
    if self.dy < 0 then
        self.y = math.max(0, ball.y + self.dy * dt)
    -- similar to before, this time we use math.min to ensure we don't
    -- go any farther than the bottom of the screen minus the ai's
